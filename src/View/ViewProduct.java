...
public class ViewProduct extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Product ID", "Product Name ", "Qantity", "Price Per Item ", "Date Came"
            }
        ));
        ...
        jLabel4.setText("List Of All Product ");
...
public void displydat(){
    ...
    List<Product> theproduct=dao.displayproductdata();
    DefaultTableModel df= (DefaultTableModel)jTable1.getModel();
    if(theproduct!=null){
        for(Product products: theproduct){
            Object[]data={
             products.getProduct_id(),
                products.getProduct_name(),
                products.getQuantity(),
                products.getPriceperItem(),
                products.getDatecames()
